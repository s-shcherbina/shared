...
type PostWithImageUserNestedRelationsWithCount = Post & Record<'image', Image> & Record<'user', UserWithImageRelation> & {
    commentCount: number;
    likeCount: number;
    dislikeCount: number;
};
export { type PostWithImageUserNestedRelationsWithCount };
//# sourceMappingURL=post-with-image-user-nested-relations-with-count.type.d.ts.map